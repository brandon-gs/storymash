    ...
    <Container maxWidth="md" className={classes.root}>
      ...
      <Accordion>
        ...
        <AccordionDetails className={classes.details}>
          ...
          <img src="/img/register.jpg" className={classes.image} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails className={classes.details}>
          ...
          <img src="/img/questions/question_2.png" className={classes.image} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
        ...
        <AccordionDetails className={classes.details}>
          ...
          <img src="/img/questions/question_3.png" className={classes.imageHeight} />
        </AccordionDetails>
      </Accordion>
      <Accordion>
        <AccordionSummary
      ...
      <Accordion>
        ...
        <AccordionDetails className={classes.details}>
          ...
          <img src="/img/questions/question_4.png" className={classes.imageHeight} />
        </AccordionDetails>
      </Accordion>
    </Container>
  )
